...
<div class="container">
    ...
    <div class="body">
        <p>Salam hormat,</p>
        <p>Borang kelulusan perjalanan berikut telah diluluskan oleh HOD dan sedia untuk semakan akauntan serta cetakan PDF.</p>
        ...
        <div class="detail-row">
            ...
            <span class="detail-value">Diluluskan</span>
        </div>

        <a href="{{ $reviewUrl }}" class="btn">Buka Senarai Akauntan</a>
    </div>
    <div class="footer">
