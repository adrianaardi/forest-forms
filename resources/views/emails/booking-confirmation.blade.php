...
<head>
    ...
    <style>
        ...
        .detail-box { background:#ebebeb border: 1px solid #dde8e1; border-radius: 8px; padding: 1rem 1.25rem; margin: 1rem 0; }
        ...
        .btn-cancel { display: inline-block; padding: 10px 20px; background: #a32d2d; color:#f7f4f4; text-decoration: none; border-radius: 6px; font-size: 13px; }
