...
<div class="container">
    ...
    <div class="body">
        <p>Salam hormat,</p>
        <p>Anda telah ditetapkan sebagai penyelia untuk permohonan berikut dan semakan anda diperlukan.</p>
        ...
        <a href="{{ $reviewUrl }}" class="btn">Buka Senarai Semakan Penyelia</a>
    </div>
    <div class="footer">
