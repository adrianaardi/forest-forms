...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 12px 24px; background: #1a4731; color: #fff; text-decoration: none; border-radius: 6px; font-size: 14px; margin: 1rem 0; }
...
<div class="container">
    ...
    <div class="body">
        ...
        <p>Terima kasih kerana mendaftar akaun Sistem Tempahan Bilik Mesyuarat. Sila klik butang di bawah untuk mengesahkan emel anda.</p>
        <a href="{{ $verifyUrl }}" class="btn">Sahkan Emel</a>
        <p class="note">Akaun anda hanya boleh log masuk selepas emel disahkan. Jika anda tidak membuat pendaftaran ini, sila abaikan emel ini.</p>
    </div>
    <div class="footer">
